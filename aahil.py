...
\033[1;91m╚═╝░░░░░╚═╝╚═╝╚═════╝░╚═╝░░╚═╝╚═╝
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════════════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗  𝙅𝘼𝙈 𝙎𝙃𝘼𝙃𝙍𝙐𝙆𝙃        ║    
\033[1;98m    ║✯ 𝙅𝘼𝙈 x 𝙈𝙞𝙨𝙝𝙖𝙡           ║  
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91m𝙅𝘼𝙈 𝙎𝙃𝘼𝙃𝙍𝙐𝙆𝙃\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91m𝙈𝙞𝙨𝙝𝙖𝙡\033[1;95m•◈•══════••◈•"
		try:
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91m𝙅𝘼𝙈 𝙎𝙃𝘼𝙃𝙍𝙐𝙆𝙃\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By 𝙅𝘼𝙈 𝙎𝙃𝘼𝙃𝙍𝙐𝙆𝙃--•◈•---»" #Dev:Jam
